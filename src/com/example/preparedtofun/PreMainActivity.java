...
public class PreMainActivity extends SlidingFragmentActivity implements SLMenuListOnItemClickListener{
...
//		setTitle(R.string.sliding_title);
        ...
        //mSlidingMenu.setMode(SlidingMenu.RIGHT);//设置左右都可以划出SlidingMenu菜单
...
//      mSlidingMenu.setBehindOffset(100);
        ...
        fragmentTransaction.replace(R.id.content1, new HomeFragment());
	...
	public void selectItem(int position, String title) {
	    ...
	    if (fragment != null) {  
	        ...
	        fragmentManager.beginTransaction()  
	                .replace(R.id.content1, fragment).commit();  
